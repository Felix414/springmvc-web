...
import com.me.java.framework.filter.LocalWebContextHolder;
...
public class WebUtils {
	...
	public static String getClientIP(){
	    ...
	    if(IP != null && IP.contains(",")){
    		...
    		for(String s:IPArray){
    		   if(s !=null && s.length()>0 && !"unknown".equalsIgnoreCase(s.trim())){
    			   IP = s.trim();
    		       break;
    		   }
    		}
	...
	//添加信息到session中
	public static void saveSession(Map<String, Object> value){
	...
	//移除信息到session中
	public static void remSession(List<String> keys){
